...
export interface DriverRaceState { driver: Driver; constructor?: Constructor | null; position?: number | null; grid_position?: number | null; laps_completed?: number | null; gap_to_leader?: number | null; gap_to_ahead?: number | null; compound?: string | null; tyre_age?: number | null; stint_number?: number | null; pit_stops_completed: number; last_lap_time?: number | null; recent_clean_pace?: number | null; status: string; laps_behind?: number | null; quality: DataQuality }
