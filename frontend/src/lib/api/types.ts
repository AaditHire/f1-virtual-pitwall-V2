...
export interface PairedOutcome { horizon_laps: 1 | 3 | 5; trajectory_count?: number; median_time_delta_seconds?: number | null; mean_time_delta_seconds?: number | null; interval_50?: [number, number] | null; interval_80?: [number, number] | null; interval_90?: [number, number] | null; pit_net_position_range_80?: [number, number] | null; extend_net_position_range_80?: [number, number] | null; pit_better_frequency?: number | null; extend_better_frequency?: number | null; equivalence_frequency?: number | null; applicability?: "RELIABLE" | "USABLE" | "WEAK" | "OUT_OF_DOMAIN" | null }
export interface PairedComparison { pit_action: string; extend_action: string; decision_horizon_laps?: 5; median_time_delta_seconds?: number | null; pit_net_position_range_80?: [number, number] | null; extend_net_position_range_80?: [number, number] | null; pit_window_state: string; outcomes: PairedOutcome[] }
export interface HistoricalPitWindow { state: "PIT_WINDOW_CLOSED" | "PIT_WINDOW_OPEN" | "PIT_WINDOW_STRONG" | "PIT_WINDOW_UNCERTAIN"; best_compound?: string | null; paired_advantage_seconds?: number | null; pit_cycle_position_advantage?: number | null; traffic: TrafficLevel; rejoin?: string | null; uncertainty: string; reason: string }
export interface PitWallAction { action: string; kind: "PIT_NOW" | "EXTEND"; policy_score?: number | null; outcomes: Array<{ horizon_laps: 1 | 3 | 5; applicability?: "RELIABLE" | "USABLE" | "WEAK" | "OUT_OF_DOMAIN" | null }> }
export interface PitWallDriver { driver: Driver; status: string; current_position?: number | null; gap_kind: "TIME" | "LAP_DEFICIT" | "UNKNOWN"; gap_to_leader_seconds?: number | null; laps_behind?: number | null; compound?: string | null; tyre_age?: number | null; recent_pace_seconds_per_lap?: number | null; traffic: string; pit_cycle_position?: number | null; recommendation?: string | null; alternative?: string | null; decision_state: "ACTIONABLE" | "CAUTION" | "COARSE_ONLY" | "INSUFFICIENT_DATA"; operating_envelope?: "SHORT_HORIZON_ONLY"; horizons_laps?: number[]; policy_recommendation?: string | null; model_disagreement: boolean; best_pit_compound?: string | null; relevant_rivals: PitWallRival[]; alerts: PitWallAlert[]; paired_comparison?: PairedComparison | null; pit_window?: HistoricalPitWindow | null; evaluated_action_count?: number; decision_margin_seconds?: number | null; uncertainty_overlap?: boolean | null; main_risk?: string | null; main_opportunity?: string | null; data_quality: Record<string, unknown>; actions?: PitWallAction[]; engineering_analysis?: DriverAnalysis | null }
