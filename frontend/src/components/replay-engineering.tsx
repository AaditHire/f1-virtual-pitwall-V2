...
import type { DriverAnalysis, DriverRaceState, PairAnalysis, PitWallDriver } from "@/lib/api/types";
import { driverCode } from "@/lib/format";
import { CompoundBadge } from "./compound-badge";
import { ConfidenceBadge, DriverEngineeringAnalysis, EvidenceLabel } from "./driver-engineering-analysis";
...
export function ReplayEngineering({ year, round, lap, selected, drivers, loaders = defaultReplayAnalysisLoaders }: Props) {
  ...
  return <aside className="replay-driver-panel replay-engineering" aria-live="polite">
    ...
    {analysis ? <div className="analysis-derived"><DriverEngineeringAnalysis analysis={analysis} drivers={drivers}/>
